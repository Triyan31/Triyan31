...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Triyan31/Triyan31/output/pacman-contribution-graph-dark.svg" />
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Triyan31/Triyan31/output/pacman-contribution-graph.svg" />
    <img alt="Animated GitHub contribution activity for Triyan31" src="https://raw.githubusercontent.com/Triyan31/Triyan31/output/pacman-contribution-graph.svg" />
  </picture>
</div>

<p align="center"><sub>Contribution activity visualized as an animated Pac-Man graph and refreshed automatically every day.</sub></p>
...
**Data & Analytics**  
`Pandas` · `Scikit-learn` · `Apache Airflow` · `Apache Spark` · `SQL` · `Power BI`
